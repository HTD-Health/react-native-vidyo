/**
 * Component to orchestrate the Vidyo connection and the various video
 * views.
 *
 * Authors:
 */
...
public class CustomVidyoView extends View implements LifecycleEventListener {
    private static final String TAG = "CustomVidyoView";
    ...
    public CustomVidyoView(ThemedReactContext context) {
        super(context);
    ...
    private void createLocalMedia() {
        ...
        Log.i("CustomVidyoView", "Create local media");
        ...
        cameraCapturer = new CameraCapturer(
            ...
            new CameraCapturer.Listener() {
                ...
                public void onFirstFrameAvailable() {
                    Log.i("CustomVidyoView", "Got a local camera track");
                }
                ...
                public void onError(int i) {
                    Log.i("CustomVidyoView", "Error getting camera");
                }
            }
        );
    ...
    public void onHostPause() {
        Log.i("CustomVidyoView", "Host pause");
        /*
    ...
    public void connectToRoomWrapper(String roomName, String accessToken) {
        ...
        Log.i("CustomVidyoView", "Starting connect flow");
        createLocalMedia();
    }
    ...
    public void switchCamera() {
        if (cameraCapturer != null) {
            ...
            pushEvent(CustomVidyoView.this, ON_CAMERA_SWITCHED, event);
        }
    }
    ...
    public void toggleVideo(boolean enabled) {
        if (localVideoTrack != null) {
            ...
            pushEvent(CustomVidyoView.this, ON_VIDEO_CHANGED, event);
        }
    }
    ...
    public void toggleAudio(boolean enabled) {
        if (localAudioTrack != null) {
            ...
            pushEvent(CustomVidyoView.this, ON_AUDIO_CHANGED, event);
        }
    }
    ...
    private Room.Listener roomListener() {
        return new Room.Listener() {
            ...
            public void onConnected(Room room) {
                ...
                pushEvent(CustomVidyoView.this, ON_CONNECTED, event);
            ...
            public void onConnectFailure(Room room, TwilioException e) {
                ...
                pushEvent(CustomVidyoView.this, ON_CONNECT_FAILURE, event);
            }
            ...
            public void onDisconnected(Room room, TwilioException e) {
                ...
                pushEvent(CustomVidyoView.this, ON_DISCONNECTED, event);

                CustomVidyoView.this.room = null;
    ...
    private void addParticipantVideo(Participant participant, VideoTrack videoTrack) {
        ...
        pushEvent(CustomVidyoView.this, ON_PARTICIPANT_ADDED_VIDEO_TRACK, event);
    }
    ...
    private void removeParticipantVideo(Participant participant, VideoTrack videoTrack) {
        ...
        WritableMap event = this.buildParticipantVideoEvent(participant, videoTrack);
        pushEvent(CustomVidyoView.this, ON_PARTICIPANT_REMOVED_VIDEO_TRACK, event);
    }
    // ===== EVENTS TO RN ==========================================================================
