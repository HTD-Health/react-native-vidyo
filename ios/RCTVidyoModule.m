...
@interface RCTVidyoModule () <TVIParticipantDelegate, TVIRoomDelegate, TVICameraCapturerDelegate>
...
RCT_EXPORT_METHOD(connect:(NSString *)accessToken roomName:(NSString *)roomName) {
  ...
  self.room = [Vidyo connectWithOptions:connectOptions delegate:self];
}
