...
class CustomVidyoView extends Component {
...
CustomVidyoView.propTypes = propTypes

const NativeCustomVidyoView = requireNativeComponent('RNCustomVidyoView', CustomVidyoView)

module.exports = CustomVidyoView
