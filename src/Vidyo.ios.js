...
const { VidyoModule } = NativeModules
...
export default class extends Component {
  ...
  constructor (props) {
    ...
    this._subscriptions = []
    this._eventEmitter = new NativeEventEmitter(VidyoModule)
  ...
  setLocalVideoEnabled (enabled) {
    return VidyoModule.setLocalVideoEnabled(enabled)
  }
  ...
  setLocalAudioEnabled (enabled) {
    return VidyoModule.setLocalAudioEnabled(enabled)
  }
  ...
  connect ({roomName, accessToken}) {
    VidyoModule.connect(accessToken, roomName)
  }
   ...
   */
  disconnect () {
    VidyoModule.disconnect()
  }

  _startLocalVideo () {
    const screenShare = false
    VidyoModule.startLocalVideo(screenShare)
  }

  _stopLocalVideo () {
    VidyoModule.stopLocalVideo()
  }

  _startLocalAudio () {
    VidyoModule.startLocalAudio()
  }

  _stopLocalAudio () {
    VidyoModule.stopLocalAudio()
  }
